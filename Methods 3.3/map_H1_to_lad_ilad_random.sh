#!usr/bin/bash
#------------------------------------------------------------------------------------------------------------------------------#
# This script will take ChIP-Seq data for H1 variants and it maps against 3 different coordinates: UCSC LADs, Inter LADs (the regions that are not LADs) and random LADs (randomized UCSC LADs' coordinates). Moreover in this 3 cases, the blacklist regions were removed. The input files are BDG files of each of the H1 variants, and as output 3 bed files, each of them having the mapped signal of all 5 H1 variants against ILADs,LADs or random LADs. Those 3 file must be downloaded to later be introduced as input in XXXXXX
#------------------------------------------------------------------------------------------------------------------------------#
# CHECK ARGUMENTS
